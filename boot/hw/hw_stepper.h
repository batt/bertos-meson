...
#define STEPPER_STROBE_ON \
	do                    \
	{ /* Implement me! */ \
	} while (0)
#define STEPPER_STROBE_OFF \
	do                     \
	{ /* Implement me! */  \
	} while (0)
...
#define STEPPER_1_SET     \
	do                    \
	{ /* Implement me! */ \
	} while (0)
/* add here the set for other stepper motor */

#define STEPPER_1_CLEAR   \
	do                    \
	{ /* Implement me! */ \
	} while (0)
 ...
 * Stepper init macro
 */
#define STEPPER_PIN_INIT_MACRO(port, index) \
	do                                      \
	{                                       \
 ...
 */
#define STEPPER_SET_CW(index) \
	do                        \
	{ /* Implement me! */     \
	} while (0)
#define STEPPER_SET_CCW(index) \
	do                         \
	{ /* Implement me! */      \
	} while (0)
#define STEPPER_SET_HALF(index) \
	do                          \
	{ /* Implement me! */       \
	} while (0)
#define STEPPER_SET_FULL(index) \
	do                          \
	{ /* Implement me! */       \
	} while (0)
#define STEPPER_SET_CONTROL_LOW(index) \
	do                                 \
	{ /* Implement me! */              \
	} while (0)
#define STEPPER_SET_CONTROL_HIGHT(index) \
	do                                   \
	{ /* Implement me! */                \
	} while (0)
#define STEPPER_SET_ENABLE(index) \
	do                            \
	{ /* Implement me! */         \
	} while (0)
#define STEPPER_SET_DISABLE(index) \
	do                             \
	{ /* Implement me! */          \
	} while (0)
#define STEPPER_SET_RESET_ENABLE(index) \
	do                                  \
	{ /* Implement me! */               \
	} while (0)
#define STEPPER_SET_RESET_DISABLE(index) \
	do                                   \
	{ /* Implement me! */                \
	} while (0)
...
#define STEPPER_RESET_MACRO(index)         \
	do                                     \
	{                                      \
 ...
 */
#define STEPPER_SET_STEP_MODE_MACRO(index, flag) \
	do                                           \
	{                                            \
		if (flag)                                \
...
#define STEPPER_SET_CONTROL_BIT_MACRO(index, flag) \
	do                                             \
	{                                              \
		/* if (flag) */                            \
...
#define STEPPER_SET_POWER_CURRENT_MACRO(index, flag) \
	do                                               \
	{                                                \
		/* if (flag) */                              \
 ...
 *
 */
#define STEPPER_SET_DIRECTION_MACRO(index, dir) \
	do                                          \
	{                                           \
		switch (dir)                            \
		{                                       \
...
#define STEPPER_SET_HALF_STEP(index, flag)              \
	do                                                  \
	{                                                   \
		switch (index)                                  \
		{                                               \
...
// Control status
#define STEPPER_SET_CONTROL_BIT(index, flag)            \
	do                                                  \
	{                                                   \
		switch (index)                                  \
		{                                               \
...
#define STEPPER_SET_POWER_CURRENT(index, flag)          \
	do                                                  \
	{                                                   \
		switch (index)                                  \
		{                                               \
...
#define STEPPER_SET_DIRECTION(index, dir)               \
	do                                                  \
	{                                                   \
		switch (index)                                  \
		{                                               \
