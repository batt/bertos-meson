...
#define ARCH_BOOT      (1 << 6)  ///< Default architecture
#define ARCH_KK348     (1 << 7)  ///< Default architecture
#define ARCH_KK353     (1 << 8)  ///< Default architecture
#define ARCH_KK354     (1 << 9)  ///< Default architecture
#define ARCH_ETH_TEST  (1 << 10) ///< Default architecture
#define ARCH_DSPLOG    (1 << 11) ///< Default architecture
