 ...
 */
#define SERRF_RX \
	(SERRF_RXFIFOOVERRUN | SERRF_RXTIMEOUT | SERRF_RXSROVERRUN | SERRF_PARITYERROR | SERRF_FRAMEERROR | SERRF_NOISEERROR) /**< All possible rx errors */
 ...
 */
	...
	#define SER_STROBE_ON \
		do                \
		{ /*nop*/         \
		} while (0)
	#define SER_STROBE_OFF \
		do                 \
		{ /*nop*/          \
		} while (0)
	#define SER_STROBE_INIT \
		do                  \
		{ /*nop*/           \
		} while (0)
#endif
