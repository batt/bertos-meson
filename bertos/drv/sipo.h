...
typedef uint16_t sipostatus_t;

	/* Software errors */
	#define SIPO_RXFIFOOVERRUN BV(0) /**< Rx FIFO buffer overrun */

DECLARE_FIFO_TYPE(uint8_t, SipoFifo, CONFIG_SIPO_RECV_BUF_SIZE);
#endif
...
typedef struct Sipo
{
	...
	int bus;                ///< Which bus we want to drive
