...
struct StepperConfig
{
	...
	struct
	{
		...
		bool noHomeSensor : 1;   ///< No home sensor installed: the motor will reach a mechanical stop when seeking home
	} flags;
};
...
struct Stepper
{
	...
	ticks_t startTime;          ///< Start time of the last movement
