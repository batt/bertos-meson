...
#include <avr/io.h>
	 ...
	 */
		...
		#define KDBG_UART0_BUS_RX \
			do                    \
			{                     \
			} while (0)
	#endif
	#ifndef KDBG_UART0_BUS_TX
		#define KDBG_UART0_BUS_TX \
			do                    \
			{                     \
			} while (0)
	#endif

	#if CPU_AVR_ATMEGA64 || CPU_AVR_ATMEGA128 || CPU_AVR_ATMEGA1281 || CPU_AVR_ATMEGA1280 || CPU_AVR_ATMEGA168 || CPU_AVR_ATMEGA328P || CPU_AVR_ATMEGA2560
		#define UCR UCSR0B
		#define UDR UDR0
		#define USR UCSR0A
	...
	#define KDBG_WAIT_READY()                  \
		do                                     \
		{                                      \
			loop_until_bit_is_set(USR, UDRE0); \
		} while (0)
	#define KDBG_WAIT_TXDONE()                \
		do                                    \
		{                                     \
			loop_until_bit_is_set(USR, TXC0); \
		} while (0)
...
typedef uint8_t kdbg_irqsave_t;
	 ...
	 */
		...
		#define KDBG_UART1_BUS_RX \
			do                    \
			{                     \
			} while (0)
	#endif
	#ifndef KDBG_UART1_BUS_TX
		#define KDBG_UART1_BUS_TX \
			do                    \
			{                     \
			} while (0)
	#endif
...
typedef uint8_t kdbg_irqsave_t;
	 ...
	 */
		...
		#define KDBG_UART2_BUS_RX \
			do                    \
			{                     \
			} while (0)
	#endif
	#ifndef KDBG_UART2_BUS_TX
		#define KDBG_UART2_BUS_TX \
			do                    \
			{                     \
			} while (0)
	#endif
...
typedef uint8_t kdbg_irqsave_t;
	 ...
	 */
		...
		#define KDBG_UART3_BUS_RX \
			do                    \
			{                     \
			} while (0)
	#endif
	#ifndef KDBG_UART3_BUS_TX
		#define KDBG_UART3_BUS_TX \
			do                    \
			{                     \
			} while (0)
	#endif
