 ...
 */
	...
	#define PHY_MII_PINS       \
		...
		| BV(PHY_TXEN_BIT) | BV(PHY_TXD0_BIT) | BV(PHY_TXD1_BIT) | BV(PHY_CRS_AD4_BIT) | BV(PHY_RXD0_AD0_BIT) | BV(PHY_RXD1_AD1_BIT) | BV(PHY_RXER_RXD4_RPTR_BIT) | BV(PHY_MDC_BIT) | BV(PHY_MDIO_BIT) | BV(PHY_TXD2_BIT) | BV(PHY_TXD3_BIT) | BV(PHY_TXER_TXD4_BIT) | BV(PHY_RXD2_AD2_BIT) | BV(PHY_RXD3_AD3_BIT) | BV(PHY_RXDV_TESTMODE_BIT) | BV(PHY_COL_RMII_BIT) | BV(PHY_RXCLK_10BTSER_BIT)
 ...
 */
	...
	#define PHY_MII_PINS       \
		BV(PHY_REFCLK_XT2_BIT) \
		| BV(PHY_TXEN_BIT) | BV(PHY_TXD0_BIT) | BV(PHY_TXD1_BIT) | BV(PHY_RXDV_TESTMODE_BIT) | BV(PHY_RXD0_AD0_BIT) | BV(PHY_RXD1_AD1_BIT) | BV(PHY_RXER_RXD4_RPTR_BIT) | BV(PHY_MDC_BIT) | BV(PHY_MDIO_BIT)
