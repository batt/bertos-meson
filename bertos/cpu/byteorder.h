...
template <>
INLINE uint16_t swab(uint16_t x) { return SWAB16(x); }
template <>
INLINE uint32_t swab(uint32_t x) { return SWAB32(x); }
template <>
INLINE uint64_t swab(uint64_t x) { return SWAB64(x); }
template <>
INLINE int16_t swab(int16_t x) { return static_cast<int16_t>(SWAB16(static_cast<uint16_t>(x))); }
template <>
INLINE int32_t swab(int32_t x) { return static_cast<int32_t>(SWAB32(static_cast<uint32_t>(x))); }
template <>
INLINE int64_t swab(int64_t x) { return static_cast<int64_t>(SWAB64(static_cast<uint64_t>(x))); }
template <>
INLINE float swab(float x) { return swab_float(x); }
